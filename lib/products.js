export const products = [
...

  {
    ...
    rating: 4.0,
    image: '/yogamat.jpg',
    imageAlt: "Eco-friendly high grip yoga mat for home and studio workouts",
...

  {
    ...
    rating: 4.2,
    image: '/muttgut.jpg',
    imageAlt: "Mutt Gutt 3 in 1 Probiotic, Prebiotic and Postbiotic Supplement for dogs",
  ...
  { 
    ...
    imageAlt: "Levoit Air Purifier for your home",
    short: 'Select Sleep Mode at night and forget all about your air purifier while you sleep.',
    long: `Powerful 56W High-Torque Motor paired with a 143 CFM CADR ensures fast, effective air cleaning. 
    Cleans rooms up to 1,073 ft² with the original filter. The Levoit original filter is HEPA-grade while 
    operating in Sleep Mode with industry-tested results. Compact Size: 8.7" × 8.7" × 14.2" | Weight: 7.9 lbs 
    – ideal for home, bedroom, or office.`,
    affiliateUrl: 'https://a.co/d/dX6HIf2'
  },
  ...
  { 
    ...
    rating: 4.2,
    image: '/scale.jpg',
    imageAlt: "Travel Scale to take away the guessing game on luggage weight",
    short: 'Keep your luggage underweight at the gate.',
    long: `This hanging baggage scale easily prevents overweight baggage charges; a must-have for traveling. 
    The travel weight scale has 110lb/50kg weight capacity, allowing you to use it for even those oversized bags. `,
    affiliateUrl: 'https://a.co/d/hSZWHVD'
  },
  ...
  { 
    ...
    rating: 4.5,
    image: '/dogbed.jpg',
    imageAlt: "Sit, sleep, and lounge in comfort",
    short: 'Memory foam and washable cover.',
    long: `The durable foam mattress is encased in a waterproof liner to fully protect the foam from spills, water damage,
    or accidents. Remove the zippered cover in seconds and machine wash for easy care.`,
    affiliateUrl: 'https://a.co/d/93LBguM'
  },
  ...
  { 
    ...
    rating: 4.3,
    image: '/pillorg.jpg',
    imageAlt: "An electronic pill organizer",

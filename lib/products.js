export const products = [
 ...
 { 
  ...
  { 
    ...
    long: `
    • Travel Voltage Converter: The 220V to 110V converter adapter combo equipped 1 DE power cable and 4 International 
    adapters (type C G, I, L) it's your good travel companion across United Kingdom, European, Italy, Australia, France, 
    Germany, Spain, Greece, South Korea, Netherlands, Norway, Poland, Portugal, China, Dubai, England, Fiji, Hong Kong, 
    Ireland, Argentina, New Zealand Russia etc, more than 200 countries over the world. 

    
    • Different Modules Voltage Conversion: The converter area is able to support a maximum 2000W total voltage peak 
    convert outlet, it converts voltage (220-240V,50/60Hz) to US voltage (110V,60Hz).

    
    • 7 in 1 International Power Adapter: This voltage converter us to europe is equipped with 3 AC Outlets and 4 USB
    charging ports(1 USB C). 


    • Portable and Safety: Compact and lightweight design to fit into luggage and briefcases, makes this step down 
    transformer 220V to 110V easy to pack and take anywhere you go.`,
